...
        <fieldset>
            <div><label>Identificador Camino: </label>&nbsp;&nbsp;<img id="id_camino_check" src="" style="display: none;"><input type="number" class="idcamino form-control" name="idpredio" ok="false"/></div>
