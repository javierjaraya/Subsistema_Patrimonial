    ...
    <table cellpadding="0" cellspacing="0" border="0" id="tabla_contactos" class="table table-striped table-bordered bootstrap-datatable dataTable">
        ...
        <tbody id="tbody">
            ...
            while($row =  oci_fetch_array($predios,OCI_RETURN_NULLS)){
                ...
                echo "<td>";
                echo "<button type='button' onclick='consultor_rodal.cargarListaInventario(".$row['ID_RODAL'].")' class='btn btn-info glyphicon glyphicon-list-alt'  title='Ver Inventarios'></button>";
                echo "</td>";
                echo "</tr>";
            }
            ?>
