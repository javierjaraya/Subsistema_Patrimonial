...
            <div><label>Comuna: </label>&nbsp;&nbsp;<img id="comuna_check" src="" style="display: none;"><input class="comuna_modificar form-control" ok="true" cols="30" rows="5" id="comuna" name="comuna" <?php echo "value='$nombreComuna'"?> /></div>
